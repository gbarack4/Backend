...
import { instructors, instructorSchools, schools, locations, services, users, schoolUsers, students, availability, availabilityBlocks, bookings, bookingForms, formFields, fieldOptions, pricingRules, invoices, notifications, invites, reviews, coupons, payments, activityLogs } from "./schema";
